    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">   
          ...
          <li class="nav-item">
            <a class="nav-link" href="reservation.html" style="color: white">Reservations</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="about.html" style="color: white">About us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="maintenance.php" style="color: white">Maintenance</a>
          </li>
...
{
mysqli_query($link, "delete from table1 where firstname='$_POST[firstname]'") or
...
{
mysqli_query($link, "update table1 set firstname='$_POST[lastname]' where
